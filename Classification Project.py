...
# #  A project on Classification Modeling in Supervised Machine Learning

# In this project we are to implement the classification algorithms in the available dataset. We import a dataset using Pandas library, apply the machine learning algorithms, and find the best classifier for this specific dataset based on model performance.
# 
...
df = pd.read_csv("C:/Users/hp/Documents/Data/loan_train.csv")
